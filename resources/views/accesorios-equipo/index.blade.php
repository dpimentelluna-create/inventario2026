                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('accesorios-equipo.create') }}" class="btn btn-primary btn-sm float-right"
                                    data-placement="left">
                                    {{ __('Registrar Nuevo') }}
                                </a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($accesoriosEquipos as $accesoriosEquipo)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('accesorios-equipo.destroy', $accesoriosEquipo->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('accesorios-equipo.show', $accesoriosEquipo->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i> {{ __('Ver') }}</a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('accesorios-equipo.edit', $accesoriosEquipo->id) }}"><i
